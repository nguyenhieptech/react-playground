    ...
    <div className="size-full overflow-y-auto">
      <div className="typography">
        ...
        <p>
          ...
          delightful web experiences. In this article, we'll explore various HTML elements
          commonly styled with modern CSS utility systems like <code>tailwindcss</code>
        ...
        <p>
          ...
          frameworks and component-based architectures, developers can build beautiful UIs
          with less effort.
        </p>
        ...
        <h2>Sample Image</h2>
        <p>
          Here's a sample image to test image styling. Make sure it scales well on all
          screen sizes.
        </p>
        <center>
          <Image
        ...
        <p>
          You can <strong>bold</strong> text, <em>italicize</em> it, <u>underline</u> it,
          or even add <a href="https://example.com">links</a>. Here’s some{" "}
        ...
        <p>
          You can <strong>bold</strong> text, <em>italicize</em> it, <u>underline</u> it,
          or even add <a href="https://example.com">links</a>. Here’s some{" "}
          <code>inline code</code> too. <mark>Highlight important info</mark> and{" "}
        ...
        <p>
          E = mc<sup>2</sup> is Einstein's mass-energy equivalence. Water is H<sub>2</sub>
          O.
        </p>
